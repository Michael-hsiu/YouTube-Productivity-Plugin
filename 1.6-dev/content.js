...
// console.log("PUSH_STATE: " + JSON.stringify(pushState));
// history.pushState(function() {
//     console.log("PUSH_STATE_EVENT!");
// })
...
function getUrlBeforeReload() {
    var promise = new Promise(function(resolve, reject) {
        ...
        chrome.storage.sync.get("currUrlKey", function(data) {
            console.log("STORAGE_URL: " + JSON.stringify(data));
            if (!isEmpty(data)) {
...
// var oldUrl = getUrlBeforeReload();
// var currUrl = null;
// var videoCount = getVideoCount();     // Total video count (all time)
var oldUrl = null;
var currUrl = null;
var videoCount = 0;     // Total video count (all time)
// var vidCountKey = "VIDEO_COUNT_KEY";
// onSetup()
...
promise.then(function(data) {
    ...
    // return new Promise((resolve, reject) => getVideoCount());
})
.then(function(vidCount) {
    videoCount = vidCount;
    console.log("VIDCOUNT: " + videoCount);
    console.log("HERE2");
    // return new Promise((resolve, reject) => getUrlBeforeReload());
    return getUrlBeforeReload();

    // oldUrl = getUrlBeforeReload();
...
// navigatedToNewPage();
// Ex. URL: https://www.youtube.com/watch?v=gje7gB5a8Y0
// Path: /watch
// Query with param: v=...
...
//     console.log("")
// })
// Add limit: current page is only valid if you stay on it for >=2 sec.

// window.addEventListener("beforeunload", function(event) {
//     console.log("UNLOAD_EVENT: " + JSON.stringify(event));
//     videoCount = 999;
// });
// window.onpopstate(function(event) {
//     console.log("POP_EVENT: " + JSON.stringify(event));
// })
